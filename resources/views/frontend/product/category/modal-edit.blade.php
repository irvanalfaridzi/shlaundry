<div class="modal fade" id="modal-category" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
                        ...
                        <form action="{{ route('frontend.product-categories.update',[$productCategory->id])}}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control" placeholder="Name" value="{{$productCategory->id}}" name="name" type="text">
                                </div>
                            </div>
