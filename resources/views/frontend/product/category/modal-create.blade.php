<div class="modal fade" id="modalCreate-category" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
            ...
            <div class="modal-body p-0">  
                <div class="card bg-secondary shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form action="{{ route('frontend.product-categories.store')}}" method="POST">
                            {{csrf_field()}}
