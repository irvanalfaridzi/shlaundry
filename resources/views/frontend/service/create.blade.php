                ...
                <div class="row">
                    <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input name="code" type="text" id="input-code" class="form-control form-control-alternative">
                            </div>
                    </div>
                </div>
            </div>  
            ...
            <div class="pl-lg-4">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <input name="name" type="text" id="input-name" class="form-control form-control-alternative" placeholder="Service name">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
            ...
            <div class="pl-lg-4">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <textarea name="description" class="form-control form-control-alternative" id="input-description" rows="5"></textarea>
                        </div>
                    </div>
                </div>
            </div>
