...
<div class="col-xl-12 col-md-12 col-sm-12 order-xl-1">
    <div class="card bg-secondary shadow">
      ...
      <div class="card-body">
        <form action="{{ route('frontend.purchase.update',[$purchase->id])}}" method="POST">
            {{csrf_field()}}
            {{ method_field('PUT')}}
            <div class="pl-lg-4">
                <div class="row">
            ...
            <div class="pl-lg-4">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="number" name="stock" id="stock" class="form-control form-control-alternative" value="{{$purchase->stock}}">
                        <input type="hidden" name="lasteststock" value="{{$purchase->stock}}">
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="supplier" class="form-control form-control-alternative" name="supplier_id">
                                @foreach ($suppliers as $supplier)
                                    <option value="{{ $supplier->id }}" @if($purchase->supplier_id == $supplier->id) selected @endif>{{ $supplier->company }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <div class="pl-lg-4">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <textarea name="note" class="form-control form-control-alternative" id="input-description" rows="5">{{$purchase->note}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
